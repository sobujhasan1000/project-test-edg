...
import img1 from "../../assets/carousel/photo1.jpg";
import img2 from "../../assets/carousel/photo2.jpg";
import img3 from "../../assets/carousel/photo3.jpg";
import img4 from "../../assets/carousel/photo4.jpg";
    ...
    <div className="carousel w-full rounded-2xl md:h-[650px]">
        ...
        <div className="absolute flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#3b3b3b] to-[rgba(21,21,21,0)]">
          <div className="text-white space-y-4 md:space-y-7 md:w-1/2 pl-12">
            <h2 className="text-3xl md:text-5xl font-bold">
              Welcome to Chemistry Corner
            </h2>
            <p>Your perfect partner is here</p>
            <div>
              <button className="btn btn-active btn-success hover:bg-orange-600 md:mr-4 ">
                Explore More
              </button>
              <button className="btn btn-outline btn-warning">News</button>
            </div>
          </div>
        </div>
      ...
      <div id="slide2" className="carousel-item relative w-full">
        ...
        <div className="absolute flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#3b3b3b] to-[rgba(21,21,21,0)]">
          <div className="text-white space-y-4 md:space-y-7 md:w-1/2 pl-12">
            <h2 className="text-3xl md:text-5xl font-bold">
              Best Ever Dating Platform
            </h2>
            <p>Do Search on your desired one</p>
            <div>
              <button className="btn btn-active btn-success hover:bg-orange-600 md:mr-4">
                Explore More
              </button>
